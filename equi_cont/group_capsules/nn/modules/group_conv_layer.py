...
from .transforms import pseudo_cartesian
from .transforms.coordinate import posevec_to_rotmat
...
class GroupConvLayer(Module):
    ...
    def __repr__(self):
        return '{}({}, {})'.format(
            self.__class__.__name__, self.convs[0].in_channels,
            self.convs[0].out_channels)
